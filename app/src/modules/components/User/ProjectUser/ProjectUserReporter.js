...
class ProjectUserReporter extends React.Component {
	...
	render() {
		...
		return (
			<select id="reporter_id" name="reporter_id" className="form-control" required ref="reporter_id">
          		{value._data}
          	</select>
		)
	}
...
ProjectUserReporter = connect(mapStateToProps, mapDispatchToProps)(ProjectUserReporter)
...
export {ProjectUserReporter,doLogic};